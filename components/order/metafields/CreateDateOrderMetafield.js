...
const CreateDateOrderMetafield = ({id})=> {
  ...
  return (
    <>
      <Heading>Create new Date Metafield</Heading>
      ...
      <TextField label="Value" value={value} onChange={handleValueChange} type="date"/>
      <Button onClick={ handleMutation } >Create Date Metafield</Button>
      {loading ? <p>Loading...</p>
...
export default CreateDateOrderMetafield;
